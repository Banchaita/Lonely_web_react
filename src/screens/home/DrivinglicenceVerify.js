...
const DrivinglicenceVerify = () => {
    ...
    // const [imagepath, setImagepath] = useState('/takepicture')
    // const [cuurentpath, setCurrentpath] = useState('/takepicturedl')
    ...
    // console.log('profile_data-----', profile_data?.driving_verification_images?.back_image)
    ...
    useEffect(() => {
        if (profile_data) {
            setFirstimage(profile_data?.driving_verification_images?.front_image)
            setSecondimage(profile_data?.driving_verification_images?.back_image)
        }
    }, [profile_data])
    ...
    useEffect(() => {
        ...
        if (typeof firstimage !== "string") {
            (async function () {
                let x = await toBase64(firstimage)
                setFile1(x)
                // console.log(x)
            })()
        }
    ...
    const handleClick = () => {
        ...
        let imgdata = {
            ...
            type: 'driving_license_verification'
        }
                                        ...
                                        <div className="col-md-6  text-dark">
                                            <div className="image-area">
                                                <label style={{ width: "100% !important", height: '100% !important' }}>
                                                    <input type="file" accept="image/*" multiple style={{ display: 'none', visibility: 'hidden' }} onChange={(event) => setFirstimage(event.target.files[0])} />
                                                    {
                                                        profile_data?.driving_verification_images?.front_image == "" ?
                                                            file1 && file1 != "" ?
                                                                <img style={{ width: "200px", height: '300px', borderRadius: '17px' }} src={file1} />
                                                                :
                                                            ...
                                                            :
                                                            <img src={`${img_url}${profile_data?.driving_verification_images?.front_image}`} className='profile-pic' style={{ width: '100%', height: '34vh' }} />
                                                    }
                                                </label>
                                            </div>
                                        </div>
                                        <div className="col-md-6  text-dark">
                                            <div className="image-area">
                                                <label style={{ width: "100% !important", height: '100% !important' }}>
                                                    ...
                                                    {
                                                        profile_data?.driving_verification_images?.back_image == "" ?
                                                            file2 && file2 != "" ?
                                                            ...
                                                            :
                                                            <img src={`${img_url}${profile_data?.driving_verification_images?.back_image}`} className='profile-pic' style={{ width: '100%', height: '34vh' }} />
                                                    }
                                                </label>
                                            </div>
                                        </div>
...
export default DrivinglicenceVerify
